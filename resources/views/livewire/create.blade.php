  ...
  <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
    ...
    <form>
      <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            ...
            <div class="mb-2">
                    <input wire:model="postId" type="hidden" placeholder="input title" class="shadow appearance-none border rounded w-full py-2 px-3 text-blue-900">
                </div>
                <div class="mb-2">
                    <label for="title" class="block">Title</label>
                    <input wire:model="title" type="text" placeholder="input title" class="shadow appearance-none border rounded w-full py-2 px-3 text-blue-900">
                </div>
                <div class="mb-2">
